...
function formHasErrors()
{
	...
	let requiredField = ["fullname","custphone","email","otherdetails"];
	...
	let custphoneField = document.getElementById("custphone");
	if(!phonenumber(custphone)){
		document.getElementById("custphoneformat_error").style.display = "block";
		if(!errorFlag){
			custphoneField.focus();
			custphoneField.select();
		}
		errorFlag = true;
	}
	//Valide email check.
